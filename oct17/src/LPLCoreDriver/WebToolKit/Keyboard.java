 ...
 * <p>
 * <br>
 * <b> Title: </b> Keyboard.java</br> <br>
 * <b> Description: </B> LPL Core Library -  Keyboard Operations </br> <br>
 * <b>Usage:</br></b> <br>
 * 1. Keyboard: Constructor without using Robot</br> <br>
 * 2. Keyboard: Constructor with Robot use</br> <br>
 * 3. type: Method to type a character sequence on screen</br> <br>
 * 4. type: Method to type a character on screen</br> <br>
 * 5. doType: Method to type a character sequence on screen by using the key code</br> <br>
 * 6. doType: Method to type a character on screen by using the key code</br>
