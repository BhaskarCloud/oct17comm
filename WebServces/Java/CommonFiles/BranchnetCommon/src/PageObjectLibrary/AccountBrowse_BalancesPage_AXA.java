 ...
 * </p>
 */
public class AccountBrowse_BalancesPage_AXA extends AccountBrowse_Common_AXA{
	...
	public final int INT_PAGEID = 343;
	
	public String[][] allObjects = null;
	
	public AccountBrowse_BalancesPage_AXA(WebDriver driver){
		super(driver);
		this.driver = driver;
