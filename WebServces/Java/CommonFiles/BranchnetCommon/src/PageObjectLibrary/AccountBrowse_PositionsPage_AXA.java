 ...
 * </p>
 */
public class AccountBrowse_PositionsPage_AXA extends AccountBrowse_Common_AXA{
	...
	public final int INT_PAGEID = 353;
	
	public AccountBrowse_PositionsPage_AXA(WebDriver driver){
		super(driver);
		this.driver = driver;
