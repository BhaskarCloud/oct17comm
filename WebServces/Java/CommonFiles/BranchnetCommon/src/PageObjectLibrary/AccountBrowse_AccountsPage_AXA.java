 ...
 * </p>
 */
public class AccountBrowse_AccountsPage_AXA extends AccountBrowse_Common_AXA{
	...
	public String strRepSearchPanel_id							= "ctl00_cph_repSearch_Table";
	
	public String strRepDropDown_id								= "ctl00_cph_repSearch_TextBox";
	...
	//Added on 09-Jan for Level 2 scripts
	...
	public final int INT_PAGEID = 341;
	
	public AccountBrowse_AccountsPage_AXA(WebDriver driver){
		super(driver);
		this.driver = driver;
