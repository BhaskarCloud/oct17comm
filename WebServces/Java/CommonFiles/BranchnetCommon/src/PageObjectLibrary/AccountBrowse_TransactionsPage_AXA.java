 ...
 * </p>
 */
public class AccountBrowse_TransactionsPage_AXA extends AccountBrowse_Common_AXA{
	...
	//Added on Jan 9 2017 - Aiswarya - Level 2
	...
	//Added by Darshana to LPL Level 2 - Added by Aiswarya on Jan 9 to AXA to ensure continuity
	...
	public final int INT_PAGEID = 354;
	
	public String[][] allObjects = null;
	
	public AccountBrowse_TransactionsPage_AXA(WebDriver driver){
		super(driver);
		this.driver = driver;
		...
		try {
			...
			if (PageObjectsMap.get("strTranTableRow").get("XPATH") != null)
				strTranTableRow_xpath = PageObjectsMap.get("strTranTableRow").get("XPATH");
	...
	public boolean fetchTransaction(){
		...
		try{
			AccountBrowse_Common_AXA abCommon = new AccountBrowse_Common_AXA(driver);
			AccountBrowse_TransactionsPage_AXA abTransactions = new AccountBrowse_TransactionsPage_AXA(driver);
