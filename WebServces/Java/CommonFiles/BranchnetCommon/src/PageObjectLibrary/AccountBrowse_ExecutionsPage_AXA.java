 ...
 * </p>
 */
public class AccountBrowse_ExecutionsPage_AXA extends AccountBrowse_Common_AXA{
	...
	//Added on Jan 9 2017 - Aiswarya - For AXA Level 2 scripts
	...
	public final int INT_PAGEID = 345;
	
	public AccountBrowse_ExecutionsPage_AXA(WebDriver driver){
		super(driver);
		this.driver = driver;
