 ...
 * <br><b>Usage:</br></b> 
 * <br>navigateToAccountBrowseTab: This method is used to click any tab link of the Account browse application in BranchNet. </br>
 * <br>clearABPages : This method is used to click clear button in any Account browse Tab</br>
 * @author Aiswarya Srinivasan
 * @since 08-17-2016 
 * </p>
 */
public class AccountBrowse_Common extends BNCommon{
	...
	//Added on 11/22/2016 for Level 2 - Aiswarya
	...
	public final int INT_PAGEID = 119;
	
	public AccountBrowse_Common(WebDriver driver){
		super(driver);
		this.driver = driver;
